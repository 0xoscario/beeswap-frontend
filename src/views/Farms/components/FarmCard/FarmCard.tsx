...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, assPrice, ethereum, account }) => {
  ...
  }, [bnbPrice, cakePrice, ethPrice, assPrice, farm.lpTotalInQuoteToken, farm.quoteTokenSymbol])
